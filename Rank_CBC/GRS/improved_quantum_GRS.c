/*
  gcc -c improved_quantum_GRS.c -lgmp && gcc -o improved_quantum_GRS ../../basic_operation.o ../Rank_CBC_params.o GRS_params.o improved_quantum_GRS.o -lgmp && ./improved_quantum_GRS
*/
    ...
    for(int index = 0; index <= 5; index++){
        ...
        if(index / 3 == 0){
            ...
            while(mpz_cmp(r, range_end) < 0){
                ...
                compute_IQGRSGloop_n_large(IQGRSGloop_n_large_Gcost, IQGRSGloop_n_large_Dcost, IQGRSGloop_n_large_ancila, m, n, k, w, r);
                
                compute_IQGRS_n_large_Dcost(IQGRS_n_large_Dcost_r, IQGRSGloop_n_large_Dcost, grover_iteration, grover_processor_num, m, w, r);
                ...
                compute_IQGRS_n_large_Gcost(IQGRS_n_large_Gcost_r, IQGRSGloop_n_large_Gcost, grover_iteration, grover_processor_num, m, w, r);

                compute_IQGRS_n_large_Wcost(IQGRS_n_large_Wcost_r, IQGRSGloop_n_large_ancila, grover_iteration, grover_processor_num, n, m, k, w, r);
            ...
            while(mpz_cmp(r, range_end) < 0){
                ...
                compute_IQGRSGloop_m_large(IQGRSGloop_m_large_Gcost, IQGRSGloop_m_large_Dcost, IQGRSGloop_m_large_ancila, m, n, k, w, r);

                compute_IQGRS_m_large_Dcost(IQGRS_m_large_Dcost_r, IQGRSGloop_m_large_Dcost, grover_iteration, grover_processor_num, n, w, r);
                ...
                compute_IQGRS_m_large_Gcost(IQGRS_m_large_Gcost_r, IQGRSGloop_m_large_Gcost, grover_iteration, grover_processor_num, n, w, r);

                compute_IQGRS_m_large_Wcost(IQGRS_m_large_Wcost_r, IQGRSGloop_m_large_ancila, grover_iteration, grover_processor_num, n, m, k, w, r);
...
void compute_IQGRS_m_large_Gcost(mpz_t IQGRS_m_large_Gcost, mpz_t IQGRSGloop_m_large_Gcost, mpz_t grover_iteration, mpz_t grover_processor_num, mpz_t n, mpz_t w, mpz_t r){
    ...
    mpz_add(IQGRS_m_large_Gcost, IQGRS_m_large_Gcost, coefficient);
...
void compute_IQGRS_m_large_Wcost(mpz_t IQGRS_m_large_Wcost, mpz_t IQGRSGloop_m_large_ancila, mpz_t grover_iteration, mpz_t grover_processor_num, mpz_t n, mpz_t m, mpz_t k, mpz_t w, mpz_t r){
    ...
    mpz_add(IQGRS_m_large_input, IQGRS_m_large_input, coefficient);
    ...
    mpz_cdiv_q(IQGRS_m_large_Wcost, IQGRS_m_large_Wcost, grover_processor_num);
    mpz_cdiv_q(IQGRS_m_large_Wcost, IQGRS_m_large_Wcost, grover_processor_num);
